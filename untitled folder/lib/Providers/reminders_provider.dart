...
class RemindersProvider extends ChangeNotifier {
  ...
  void addReminders(String name, String dose, String time, String description, String noOfTimes) {
    Reminder reminder = Reminder(name, dose, time, description, noOfTimes);
